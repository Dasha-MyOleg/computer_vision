...
img = cv2.imread('L_5_Equal_Sentinel_2022.jpg')
...
img = cv2.imread('L_5_Equal_Sentinel_2022.jpg',0)
...
img = cv2.imread('L_5_Equal_Sentinel_2022.jpg',0)
# img = cv2.imread('Maple2.jpg',0)
equ = cv2.equalizeHist(img)
res = np.hstack((img,equ))
cv2.imwrite('L_5_Rez_equalizeHist.png',res)
